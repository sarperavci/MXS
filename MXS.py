...
argparser.add_argument("-t", "--timeout", help="Request timeout", type=float, default=4)
...
if __name__ == "__main__":
    scanner = MassScanner(args.input, args.output , args.concurrency, args.timeout, args.hidden)
    scanner.run()